...
jupyter notebook notebook/lab6_tutorial.ipynb
# Hoặc chạy script python nếu đã tách thành script
python Lab_6/examples/run_lab6_examples.py
```

## Links (quick)
- Notebook (GitHub): https://github.com/nghiemvietquant67-sys/NLP-APP/blob/main/notebook/lab6_tutorial.ipynb
- Report (GitHub): https://github.com/nghiemvietquant67-sys/NLP-APP/blob/main/report/lab6_report.md
